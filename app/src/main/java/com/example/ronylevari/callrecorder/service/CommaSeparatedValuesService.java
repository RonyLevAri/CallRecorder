...
public class CommaSeparatedValuesService extends IntentService {
    ...
    public static final String ACTION_WRITE_TO_FILE = "com.example.ronylevari.callrecorder.service.action.ACTION_EXPORT_TO_MAIL";

    public static final String EXTRA_PARENT = "com.example.ronylevari.callrecorder.service.extra.PARENT";
    public static final String EXTRA_TRASHED = "com.example.ronylevari.callrecorder.service.extra.TRASHED";
    ...
    private String writeToCsv(ArrayList<ChildRecordItem> children) {
        ...
        try {
            ...
            while(it.hasNext()) {
                ...
                fos.write(COMMA_DELIMITER.getBytes());
                fos.write(Utils.getDateTime(current.getCallTime()).getBytes());
                fos.write(COMMA_DELIMITER.getBytes());
