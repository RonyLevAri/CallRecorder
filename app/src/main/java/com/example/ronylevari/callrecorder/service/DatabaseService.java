...
public class DatabaseService extends IntentService {
    ...
    public static final String ACTION_INSERT_PARENT = "com.example.ronylevari.callrecorder.service.action.ACTION_WRITE_PARENT";
    public static final String ACTION_INSERT_CHILD = "com.example.ronylevari.callrecorder.service.action.ACTION_WRITE_CHILD";
    public static final String ACTION_TRASH_PARENT = "com.example.ronylevari.callrecorder.service.action.ACTION_TRASH_PARENT";
    public static final String ACTION_TRASH_CHILD = "com.example.ronylevari.callrecorder.service.action.ACTION_TRASH_CHILD";
    public static final String ACTION_CLOSE_PARENT = "com.example.ronylevari.callrecorder.service.action.ACTION_CLOSE_PARENT";
    public static final String ACTION_DELETE_PARENT = "com.example.ronylevari.callrecorder.service.action.ACTION_DELETE_PARENT";
    public static final String ACTION_DELETE_CHILD = "com.example.ronylevari.callrecorder.service.action.ACTION_DELETE_CHILD";
    public static final String ACTION_MERGE_PARENTS = "com.example.ronylevari.callrecorder.service.action.ACTION_MOVE_CHILD_TO_DIFFERENT_PARENT";
